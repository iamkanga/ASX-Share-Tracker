...
self.addEventListener('install', (event) => {
    ...
    event.waitUntil(
        caches.open(CACHE_NAME)
            .then((cache) => {
                console.log('Service Worker v26: Cache opened'); // Updated log for version
            ...
            .then(() => {
                ...
                self.skipWaiting();
                console.log('Service Worker v26: Installation complete and skipWaiting called.'); // Updated log
            })
            .catch((error) => {
                console.error('Service Worker v26: Cache addAll failed during install:', error); // Updated log
            })
    );
});
...
self.addEventListener('activate', (event) => {
    ...
    event.waitUntil(
        caches.keys().then((cacheNames) => {
            ...
            console.log('Service Worker v26: Old caches cleared, claiming clients.'); // Updated log
